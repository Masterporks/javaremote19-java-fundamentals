package petrolStation.petrolstation;

import java.util.Random;
import java.util.Scanner;

public class PetrolStation {
    private static final double PETROL_PRICE_PER_LITRE = 1.988;
            ...
            if (isContinue()) {
                ...
                while (!isMoneyPaid) {
                    ...
                    if (money == totalAmount) {
                        ...
                        System.out.println("The amount paid is lesser than total amount! Please pay the correct amount");

                    }

                }
            } else{
                System.out.println("Invoice will be sent to you! Thank you for visiting!");
            }
        }
    }
    ...
    private static double getMoney(){
        ...
        return new Random().nextDouble(2000 - 1) + 1;
    }
